            ...
            <div class="span2">
                <div class="well sidebar-nav">
                    <ul class="nav nav-list">
                        ...
                        <li class="active"><a href="invoiceslist.php"><i class="icon-group icon-2x"></i> Invoices</a></li>
            ...
            <div class="span10">
                ...
                <div style="margin-top: -19px; margin-bottom: 21px;">
                    ...
                    <?php
                        ...
                        $sql1 = "SELECT COUNT(*) AS count1 FROM invoices";
                        $result1 = $conn->query($sql1);
                        $row1 = $result1->fetch_assoc();
                        $rowcount = $row1['count1'];

                        $sql2 = "SELECT COUNT(*) AS count2 FROM invoices WHERE total_amount< 10";
                ...
                <input type="text" style="padding:15px;" name="filter" value="" id="filter" placeholder="Search invoice No..." autocomplete="off" />
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<a rel="facebox" href="editinvoice.php?id=' . $row['invoice_id'] . '"><button class="btn btn-warning btn-mini"><i class="icon-edit icon-white"></i> Edit</button></a>';
        echo '<form method="POST" action="deleteinvoice.php" style="margin-left: 5px;">';
        echo '<input type="hidden" name="id" value="' . $row['invoice_id'] . '">';
