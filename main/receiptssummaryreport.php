    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="contentheader">
                <i class="icon-bar-chart"></i> Receipts Summary Report
            </div>
            <ul class="breadcrumb">
                <li><a href="index.php">Dashboard</a></li>
                <li class="active">Receipts Summary Report</li>
            </ul>

            <!-- Form to search receipts summary -->
            <div style="margin-top: 20px;">
                <center>
                    <form action="receiptssummaryreport.php" method="POST">
                        <span for="d1">From:
                    ...
                    if ($stmt) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $totalReceiptsSummary += (float)$row['total_amount'];
                            }
